        ...
        >
          <div className="flex-shrink-0 flex items-center justify-between px-4 py-3 border-b border-border">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-xs font-semibold leading-none">Ask {displayName}</p>
                <p className="text-[10px] text-muted-foreground mt-0.5">AI Agent · Powered by public knowledge</p>
              </div>
            </div>
            <button
